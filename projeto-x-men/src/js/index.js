...
personagens.forEach((personagem) => {
    personagem.addEventListener('mouseenter', () =>{
        ...
        const nomePerso = document.getElementById('nome-perso')

        nomePerso.innerHTML = personagem.getAttribute('data-name')

        const descricaoPerso = document.getElementById('descricao')
        descricaoPerso.innerText = personagem.getAttribute('data-description')
    })
})